package tr.org.linux.kamp2016.date;
...
public class DateTimeAPI {
	...
	public void testLocalDateTime() {
		...
		LocalDateTime timeExample = currentTime.withDayOfMonth(8)
				.withYear(2016);
		...
		System.out.println("justAnotherLocalTimeExample: "
				+ justAnotherLocalTimeExample);
